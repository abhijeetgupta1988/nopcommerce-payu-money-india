...
public class PayuPaymentProcessor : BasePlugin, IPaymentMethod
{
    ...
    public async Task PostProcessPaymentAsync(PostProcessPaymentRequest postProcessPaymentRequest)
    {
        ...
        remotePostHelper.Add("surl", _webHelper.GetStoreLocation(true) + "Plugins/PaymentPayu/Return");
        remotePostHelper.Add("furl", _webHelper.GetStoreLocation(true) + "Plugins/PaymentPayu/Return");
    ...
    {
        return typeof(PaymentPayuViewComponents);
    }
